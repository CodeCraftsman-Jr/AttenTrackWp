        ...
        return new Promise((resolve, reject) => {
            ...
            jQuery.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        resolve(response.data.test_id);
                    } else {
                        reject(response.data?.message || 'Failed to get test ID');
                    }
                },
            ...
            jQuery.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.success) {
                        ...
                        if (response.data?.message === 'Please log in to take the test') {
                            window.location.href = window.attentrack_ajax.login_url + '?redirect_to=' + encodeURIComponent(window.location.href);
                            return;
                        }

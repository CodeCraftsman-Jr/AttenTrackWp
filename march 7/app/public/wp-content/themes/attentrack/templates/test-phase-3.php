<?php
/**
 * Template Name: Test Phase Three
 */
 ...
 <body>
     ...
     <script>
         ...
         async function fetchUniqueTestID() {
             try {
                 const response = await fetch('<?php echo admin_url('admin-ajax.php'); ?>', {
                     ...
                     body: 'action=get_unique_test_id&nonce=<?php echo wp_create_nonce('get_unique_test_id'); ?>'
                 });
         ...
         function submitForm() {
             ...
             formData.append('entry.1797772207', missedCount); // Replace with entry ID for missed_count
             formData.append('entry.1576321042', incorrectCount); // Replace with entry ID for incorrect_count
         ...
         continueButton.addEventListener('click', function() {
             submitForm();
             setTimeout(() => {
                 window.location.href = "<?php echo esc_url(home_url('/testbreak?next=test1phase4')); ?>";
             }, 1000);
         });

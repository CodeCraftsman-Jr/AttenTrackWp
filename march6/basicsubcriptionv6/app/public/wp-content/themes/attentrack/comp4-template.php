...
<div class="container" style="margin-top: 100px;">
    <div class="section">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <h1>Dividend Attention</h1>
                <h2>Procedure Overview</h2>
                <p>You will see a sequence of colour and an audio sound saying 'Green/Red/yellow/violet/blue/orange/indigo'.
You should click the colour as you hear in audio.
Sequence of colour will be displayed for 2 seconds.
You can choose the response only once.
Total duration is 1 minute</p>
            </div>
        </div>
    </div>
    ...
    <div class="section">
        ...
        <div class="video-container">
            <iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/Yb-KvMauazY?si=ElDYFjG_2wndCANM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
    </div>
</div>

...
Tags: login, Custom login, login logo, Sign In, temporary login, login URL, Sign out, rename login, restrict content, block access, hide login, private site, login customizer, temporary access, admin customizer, customize admin, social login, dashboard, admin dashboard, wp-admin, admin login, limit login, login attempts, login protection, private site, locked site, private page, locked page 
...
License URI: https://www.gnu.org/licenses/gpl-2.0.html  
 ...
 Customize , Block Login Attempts , Enhance , Change URL of Your WordPress Admin Login Page, and More.

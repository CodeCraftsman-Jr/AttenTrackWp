     ...
     <div id="test-area" class="position-relative">
         ...
         <script>
             ...
             function showModal() {
                 ...
                 let totalResponses = totalCount;
                 let accuracy = (correctCount / totalResponses) * 100;
                 let score = Math.round(accuracy * 0.8); // Simple scoring based on accuracy
                 ...
                 jQuery.ajax({
                     ...
                     data: {
                         ...
                         score: score,
                         accuracy: accuracy,
                         reaction_time: letterInterval / 1000, // Using fixed interval as reaction time
             ...
             continueButton.addEventListener('click', function() {
                 window.location.href = '<?php echo get_permalink(get_page_by_path('test-phase-4')); ?>';
             });

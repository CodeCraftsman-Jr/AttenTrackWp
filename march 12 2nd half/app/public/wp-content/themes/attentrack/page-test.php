...
jQuery(document).ready(function($) {
    ...
    function startTest() {
        ...
        $.ajax({
            ...
            data: {
                ...
                nonce: '<?php echo wp_create_nonce('create_test_session'); ?>',
                test_id: '<?php echo uniqid('test_'); ?>'
            },
            success: function(response) {
                if (response.success) {
                    ...
                    console.error('Error creating test session:', response.data.message);
    ...
    function saveResults(results) {
        if (!testId || !testSessionId) {
            console.error('Missing test session information');
            return;
        }
        ...
        $.ajax({
            ...
            data: {
                ...
                reaction_time: results.responseTime / 1000,
                missed_responses: 0, // Update with actual value
                false_alarms: 0, // Update with actual value
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    $.ajax({
                        ...
                        type: 'POST',
                        data: {
                            action: 'complete_test_session',
                            nonce: '<?php echo wp_create_nonce('complete_test_session'); ?>',
                        ...
                        success: function(response) {
                            if (response.success) {
                                ...
                                console.error('Error completing test session:', response.data.message);
                            }
                        },
                        error: function() {
                    ...
                    console.error('Error saving results:', response.data.message);
                }
            },
            error: function() {

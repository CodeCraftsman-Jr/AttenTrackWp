    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            if ($test_page) {
                ...
                echo '<p>Access the test page here: <a href="' . esc_url($test_url) . '" target="_blank" class="btn btn-primary">Open Test Page</a></p>';
            } else {
                echo '<div class="alert alert-warning">Test page not found. Please create a page with the slug "test-phase-0".</div>';
            }
            ?>
        </div>
    </div>

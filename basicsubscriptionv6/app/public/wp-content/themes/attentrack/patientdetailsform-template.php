...
$patient_id = get_user_meta($current_user_id, 'patient_id', true);

// If no patient ID exists, redirect to home page
if (empty($patient_id)) {
...
<div class="container">
    ...
    <form id="patientForm">
        <div class="form-group">
            ...
            <input type="text" id="patientId" name="patientId" value="<?php echo esc_attr($patient_id); ?>" required readonly>
        </div>
        <div class="form-group">
    ...
    try {
        ...
        if (data.success) {
            ...
            document.getElementById('nextTestButton').addEventListener('click', function() {
                window.location.href = '<?php echo esc_url(home_url("/selectionpage")); ?>';
            });
        } else {

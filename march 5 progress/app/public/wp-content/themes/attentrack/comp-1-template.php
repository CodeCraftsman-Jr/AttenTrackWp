    ...
    <div class="container" style="margin-top: 100px;">
        <div class="section">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <h1>Selective Attention</h1>
                    <h2>Procedure Overview</h2>
                    <p>The alphabet such as 'P,b,d,q,R' will appear on the computer screen
                    Each of the mentioned alphabets will be displayed one at a time in computer screen for 1 second.ffectively and efficiently
                    You have to click 'P' whenever the alphabet 'P'appears on the screen. Do not press any other key
                    Totally 200 stimuli will appear. After 50 stimuli there will blank screen for 30 seconds, for 1 sets will be displayed
                    Total time will be approximately 60 Seconds.</p>
                </div>
            </div>
        </div>

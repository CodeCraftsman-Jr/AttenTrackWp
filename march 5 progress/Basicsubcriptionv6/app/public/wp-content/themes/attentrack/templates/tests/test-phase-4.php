        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" id="continueButton" class="btn btn-primary">View Final Results</button>
                </div>
            </div>
        </div>
    </div>
...
jQuery(document).ready(function($) {
    ...
    inputBox.on('input', function() {
        ...
        if (input.length === 1) {
            ...
            responses.push({
                ...
                correct: (currentLetter === 'R' && input === 'R') || (currentLetter !== 'R' && input !== 'R')
            });
    ...
    function submitResults() {
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    window.location.href = '<?php echo esc_url(home_url('/test-results')); ?>';
                }
            }
        });
    }

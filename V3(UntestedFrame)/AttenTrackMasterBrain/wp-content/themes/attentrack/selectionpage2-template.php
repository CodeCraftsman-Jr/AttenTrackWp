...
<div class="container">
    ...
    <div class="grid-container">
        <div class="grid-item" id="test1" onclick="test1Clicked()">
            <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/test1.jpg" alt="Selective Attention Test">
            <div class="content">
        ...
        <div class="grid-item" id="test2" onclick="test2Clicked()">
            <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/test2.jpg" alt="Sustained Attention Test">
            <div class="content">
        ...
        <div class="grid-item" id="test3" onclick="test3Clicked()">
            <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/test3.jpg" alt="Alternative Attention Test">
            <div class="content">
        ...
        <div class="grid-item" id="test4" onclick="test4Clicked()">
            <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/test4.jpg" alt="Dividend Attention Test">
            <div class="content">
...
<div id="instructionModal" class="modal">
    <div class="modal-content">
        ...
        <h2 id="modalHeader" class="modal-header"></h2>
        <p id="modalBody" class="modal-body"></p>
        <button id="modalButton" class="modal-button">Start Test</button>
    </div>
</div>
...
function showInstructionCard(title, message, redirectUrl) {
    ...
    document.getElementById('modalButton').onclick = () => window.location.href = redirectUrl;
...
function test1Clicked() {
    showInstructionCard(
        ...
        '<?php echo esc_url(home_url("/comp-1")); ?>'
    );
}
...
function test2Clicked() {
    if (!document.getElementById('test2').classList.contains('disabled')) {
        showInstructionCard(
            ...
            '<?php echo esc_url(home_url("/comp-2")); ?>'
        );
    }
}
...
function test3Clicked() {
    if (!document.getElementById('test3').classList.contains('disabled')) {
        showInstructionCard(
            ...
            '<?php echo esc_url(home_url("/comp-3")); ?>'
        );
    }
}
...
function test4Clicked() {
    if (!document.getElementById('test4').classList.contains('disabled')) {
        showInstructionCard(
            ...
            '<?php echo esc_url(home_url("/comp-4")); ?>'
        );
    }
}

...
jQuery(document).ready(function($) {
    ...
    inputBox.on('input', function() {
        ...
        if (input.length === 1) {
            ...
            responses.push({
                ...
                correct: (currentLetter === 'Q' && input === 'Q') || (currentLetter !== 'Q' && input !== 'Q')
            });
    ...
    function submitResults() {
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    window.location.href = '<?php echo esc_url(home_url('/test-break-3')); ?>';
                }
            }
        });
    }

...
<!-- Bootstrap Navbar -->
<nav class="navbar navbar-expand-lg navbar-light bg-body-tertiary" style="margin: 7px;">
    <div class="container-fluid">
        <?php if (has_custom_logo()): ?>
            <?php the_custom_logo(); ?>
        <?php else: ?>
            <img src="<?php echo site_url(); ?>/wp-content/includes/images/logo.jpg" width="85px" alt="<?php bloginfo('name'); ?>">
        <?php endif; ?>

...
<body>
    ...
    <div id="test-id">Test ID: 12345</div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function showBreakScreen() {
            ...
            elements.phaseResults.innerHTML = `
                ...
                Accuracy: ${phaseResults[phaseResults.length - 1].accuracy.toFixed(1)}%<br>
                Average Reaction Time: ${phaseResults[phaseResults.length - 1].avgReactionTime.toFixed(3)}s<br>
                Missed Responses: ${phaseResults[phaseResults.length - 1].missedCount}<br>
                False Alarms: ${phaseResults[phaseResults.length - 1].falseAlarms}<br>
                Score: ${phaseResults[phaseResults.length - 1].score}
            `;
            ...
            jQuery.ajax({
                ...
                data: {
                    ...
                    results: {
                        testId: testId,
                        profileId: profileId,
                        phases: phaseResults.map((phase, index) => ({
                            phase: index + 1,
                            totalLetters: phase.totalLetters,
                            pLetters: phase.pLetters,
                            correctResponses: phase.correctResponses,
                            incorrectResponses: phase.incorrectResponses || 0,
                            reactionTime: phase.avgReactionTime,
                            score: phase.score
                        })),
                        overallAccuracy: finalResults.overallAccuracy,
                        overallReactionTime: finalResults.overallReactionTime,
                ...
                success: function(response) {
                    ...
                    console.log('Phases sent to server:', phaseResults);

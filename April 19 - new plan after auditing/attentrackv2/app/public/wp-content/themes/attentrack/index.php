    ...
    <div class="overlay-container">
        <div class="wel2-text">
            ...
            <div class="hero-quotes">
                <h3 style="color: white ;">"Strength doesn't come from what you can do, it comes from overcoming the things you once thought you couldn't."</h3>
                <h3 style="color: white;">"Focus on progress, not perfection!"</h3>
                <h3 style="color: white;">"Small steps lead to big leaps."</h3>
                <h3 style="color: white;">"You're not lazy—you just think differently!"</h3>
                <h3 style="color: white;">"Celebrate every small win—it's all progress!"</h3>
            </div>
        </div>
    </div>
</section>

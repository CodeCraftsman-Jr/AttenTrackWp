...
$viewing_user_id = 0;
if (isset($viewing_user_id) && $viewing_user_id > 0) {
    // The viewing_user_id is already set by the page-dashboard.php file
} elseif (current_user_can('institution') && isset($_POST['view_user_id']) && isset($_POST['view_user_nonce'])) {
    ...
    <div class="sidebar bg-light p-4" style="width: 300px;">
        ...
        <div class="card mb-4">
            <div class="card-body text-center">
                ...
                <div class="mt-3">
                    <button id="editProfileBtn" class="btn btn-sm btn-outline-primary w-100" data-bs-toggle="modal" data-bs-target="#editProfileModal">Edit Profile</button>
                </div>
            </div>
        </div>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade show active" id="profileDetails" role="tabpanel">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p>First Name: <?php echo esc_html($patient_details_db['first_name']); ?></p>
                        <p>Last Name: <?php echo esc_html($patient_details_db['last_name']); ?></p>
                        <p>Age: <?php echo esc_html($patient_details_db['age']); ?></p>
                        <p>Gender: <?php echo esc_html($patient_details_db['gender']); ?></p>
                        <p>Email: <?php echo esc_html($patient_details_db['email']); ?></p>
                        <p>Phone: <?php echo esc_html($patient_details_db['phone']); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-body">
                <form id="patientEditForm">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="firstName" name="firstName" value="<?php echo esc_attr($patient_details_db['first_name']); ?>">
                    </div>
                    <div class="mb-3">
                        <label for="lastName" class="form-label">Last Name</label>
                        <input type="text" class="form-control" id="lastName" name="lastName" value="<?php echo esc_attr($patient_details_db['last_name']); ?>">
                    </div>
                    <div class="mb-3">
                        <label for="age" class="form-label">Age</label>
                        <input type="number" class="form-control" id="age" name="age" value="<?php echo esc_attr($patient_details_db['age']); ?>">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" id="email" name="email" value="<?php echo esc_attr($patient_details_db['email']); ?>">
                    </div>
                    <div class="mb-3">
                        <label for="phone" class="form-label">Phone</label>
                        <input type="text" class="form-control" id="phone" name="phone" value="<?php echo esc_attr($patient_details_db['phone']); ?>">
                    </div>
...
jQuery(document).ready(function($) {
    ...
    $('#saveProfileChanges').on('click', function(e) {
        e.preventDefault();
        ...
        $.post(ajaxurl, formData, function(response) {
            if (response.success) {
                ...
                $('<div class="alert alert-success mt-3">Profile updated successfully!</div>')
                    .insertAfter('#editProfileMessage')
                    .delay(3000)
                    .fadeOut();

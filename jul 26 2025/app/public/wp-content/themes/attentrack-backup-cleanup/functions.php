...
// Include test suite for administrators (commented out - no longer needed)
// if (current_user_can('administrator')) {
//     require_once get_template_directory() . '/tests/test-suite.php';
// }

// Add admin menu for testing (administrators only) - REMOVED
// function attentrack_add_admin_menu() {
//     if (current_user_can('administrator')) {
//         add_management_page(
//             'AttenTrack System Tests',
//             'AttenTrack Tests',
//             'administrator',
//             'attentrack-tests',
//             'attentrack_admin_test_page'
//         );
//     }
// }
// add_action('admin_menu', 'attentrack_add_admin_menu');

// Admin test page callback - REMOVED
// function attentrack_admin_test_page() {
//     include get_template_directory() . '/admin-test-page.php';
// }
...
// Add admin menu for debugging - REMOVED
// function attentrack_add_debug_menu() {
//     add_submenu_page(
//         'tools.php',
//         'AttenTrack Subscription Debug',
//         'Subscription Debug',
//         'manage_options',
//         'attentrack-subscription-debug',
//         'attentrack_subscription_debug_page'
//     );
// }
// add_action('admin_menu', 'attentrack_add_debug_menu');
...
// User Role Migration menu - REMOVED
// add_action('admin_menu', function() {
//     add_management_page('User Role Migration', 'User Role Migration', 'manage_options', 'user-role-migration', 'add_migration_button');
// });

<?php
/*
Template Name: Instruction Test 11 Template
*/
...
<div class="container">
    ...
    <ul>
        ...
        <li>Total time will be approximately 60 Seconds</li>
    </ul>
    <a href="<?php echo esc_url(home_url('/test-11')); ?>" class="start-test-btn">Start Test</a>
    <div class="footer">
